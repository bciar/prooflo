...
<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="margin-bottom: 0px;">
          ...
          <tr>
            ...
            The currrent project: <b>{{$project_name}}</b>  has been set as finished by client. The client agree with the final results. To see the final comments for the current revision, click the button below
              <br>
            </td>
          </tr>
          <tr>
