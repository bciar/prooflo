...
<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="margin-bottom: 0px;">
          ...
          <tr>
            ...
            There are some comments about the project <b>{{$project_name}}</b>, follow the link above to open the current revision and check it out.
              <br>
            </td>
          </tr>
          <tr>
